package com.fannan.springDataWithElasticsearch;
//
...
//		kafkaTemplate.send("fannan", jsonConverter.toJson(simpleModel));
//	}
//
//	@PostMapping("/v2")
//	public void post(@RequestBody MoreSimpleModel moreSimpleModel) {
//		kafkaTemplate.send("fannan2", jsonConverter.toJson(moreSimpleModel));
//	}
//
//	@KafkaListener(topics = "fannan")
